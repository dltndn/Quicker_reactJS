...
export const useOrderStore = create<OrderState>((set) => ({
  ...
  setCreatedOrderNum: (createdOrderNum: string | undefined) =>
    set({ createdOrderNum }),
...
export const useDivHandler = create<useDivHandler>((set) => ({
  ...
  setShowCommissionPage: (showCommissionPage: boolean) =>
    set({ showCommissionPage }),
}));
...
export const useOrderDataStore = create<useOrderDataStore>((set) => ({
  ...
  senderPhoneNumber: "",
  setSenderPhoneNumber: (senderPhoneNumber: string) =>
  ...
  receiverPhoneNumber: "",
  setReceiverPhoneNumber: (receiverPhoneNumber: string) =>
...
export default function CommissionPage() {
  ...
  const setDeadlineToProp = () => {
    if (date !== null && AMPM !== null && hour !== null && minute !== null) {
      const timeStamp = Time.parseTimeStamp(
        date,
        AMPM,
        hour,
        minute
    ...
    <>
      ...
      {showAllowance ? (
        ...
        <>
          <div
            style={
              showCommissionPage ? { display: "block" } : { display: "none" }
            }
          >
            <Tmap
              states={{
          ...
          <div
            style={
              showCommissionPage ? { display: "none" } : { display: "block" }
            }
          >
            <RequestPage sendData={forSendData} />
          </div>
          <BottomBar />
        </>
      )}
